...
char* Salt::getAnion(int position)
{
	return ANION[position];
}

char* Salt::getCation(int position)
{
	return CATION[position];
}
...
int main(int argc, char const *argv[]) {
    ...
    getch();system("cls");system("color 4f");
    cout << "\t|-**************************************************************-|\n";
    cout << "\t\t\t    WELCOME TO SALT ANALYSER \n";
    cout << "\t|-**************************************************************-|\n";
    cout << "\n\t Instructions:-\n\n";
    cout << "\t 1. This is a purely menu based user friendly\n\t    program that will help you";
    cout << "determine the anion and cations in\n\t    the given salt packet.\n";
    cout << "\n\t 2. What you need to do is to answer a few questions\n\t    on the basis of your observatons.\n";
    cout << "\n\t 3. In the end, the result will be displayed as per the\n\t    observations\n";
    cout << "\n\t 4. To know more, you can simply head to the about section from\n\t    the menu\n";
	cout << "\n\t|-**************************************************************-|\n";
    cout << "\n\n Press any key to continue... " << '\n';
    getch();system("cls");system("color 5e"); cout<<"\n\n\n\n\n\n\n\n";
    cout << "\t\t\t\t _                   _\n";
    cout << "\t\t\t\t|_)  _   _.  _|       )\n";
    cout << "\t\t\t\t| ( (/_ (_| (_|  {/  |\n";
    cout << "\t\t\t\t                 /   o \n";
    cout << "\n\n\n\n\n\n\n Press any key to continue... " << '\n';
    getch();system("cls");system("color 9d");
